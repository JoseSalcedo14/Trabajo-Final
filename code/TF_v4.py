...
class Ruta:
    ...
    @tarifa_mens.setter
    def tarifa_mens(self, nva_tarifa_mens):
    ...
    @cant_alumnos.setter
    def cant_alumnos(self, nva_cant_alumnos):
...
class Vehiculo:
    ...
    @placa_veh.setter
    def placa_veh(self, nva_placa_veh):
...
class Conductor(Persona):
    ...
    @cad_brevete.setter
    def cad_brevete(self, nva_cad_brevete):
...
class Estudiante(Persona):
    ...
    def ruta_asignada(self, nueva_ruta):
        self.__ruta_asignada = nueva_ruta
